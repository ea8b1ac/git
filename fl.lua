...
if _G.flingbot.Whitelisted and _G.flingbot.Message then
    Settings.Whitelisted = _G.flingbot.Whitelisted
        
    Settings.Message.enabled = _G.flingbot.Message.enabled
    Settings.Message.src = _G.flingbot.Message.src
end
...
local function Initialize()
    ...
    if Client.Character:FindFirstChild("HumanoidRootPart") and Client.Character:FindFirstChild("Humanoid") and Client.Character.Humanoid.Health > 0 then
        ...
        if not table.find(Settings.Whitelisted, Client.Name) then
            print('im a bot')
            ...
            local function getEligiblePlayers()
                ...
                for index, player in pairs(game.Players:GetPlayers()) do
                    if not table.find(player.Name, Settings.Whitelisted) then
